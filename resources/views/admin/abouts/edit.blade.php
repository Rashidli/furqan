                    ...
                    <div class="card-body">
                        <nav aria-label="breadcrumb" style="margin-bottom: 20px;">
                            <ol class="breadcrumb bg-light p-3 rounded">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('abouts.index') }}">Haqqımızda siyahı</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $about->translate('en')?->title }}</li>
                            </ol>
                        </nav>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="az_title" value="{{ old('az_title', $about->translate('az')->title) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{ old('en_title', $about->translate('en')->title) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{ old('ru_title', $about->translate('ru')->title) }}">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_az" class="form-control" type="text" name="az_description">{{ old('az_description', $about->translate('az')->description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_en" class="form-control" type="text" name="en_description">{{ old('en_description', $about->translate('en')->description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_ru" class="form-control" type="text" name="ru_description">{{ old('ru_description', $about->translate('ru')->description) }}</textarea>

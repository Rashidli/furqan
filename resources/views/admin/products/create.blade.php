                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" name="discount_percent" value="{{ old('discount_percent') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="option_ids[]">
                                            ...
                                            @foreach($filter->options as $option)
                                                <option value="{{ $option->id }}" {{ in_array($option->id, old('option_ids', [])) ? 'selected' : '' }}>
                                                    {{ $option->title }}
                                                </option>
                                            @endforeach
                                        </select>

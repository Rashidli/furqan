                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        @foreach($vacancies as $vacancy)
                                            ...
                                            <tr>
                                                ...
                                                {{--                                                <td><img src="{{asset('storage/'.$vacancy->image)}}" style="width: 100px; height: 50px" alt=""></td>--}}
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{route('vacancies.edit',$vacancy->id)}}" class="btn btn-primary"
                                ...
                                <br>
                                {{ $vacancies->links('admin.vendor.pagination.bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
